...
public class Asteroid extends Character {
    ...
    private List<ImageView> imagesOfAsteroids;

    public Asteroid(ImageView imageViewOfAsteroid, int x, int y, ScreenSize screenSize) throws MalformedURLException {
        super(imageViewOfAsteroid, x, y, screenSize);

...
import com.asteroids.Characters.Character;
...
public class GameStateScene {
    ...
    public Ship createShip() {
        ...
        //this.ship = new Ship(imageView, screenSize.getGameHeight()/2, screenSize.getGameWidth()/2, 50, 51);
    ...
    public void play() {
        ...
        animationTimer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                asteroidList.forEach(Character::isInBorder);
                listOfShots.forEach(Character::move);
                listOfShots.forEach(ProjectLines::isInBorder);
    ...
    public void setDifficulty() throws IOException {
        ...
        hardButton.setOnAction(event -> {
            if (mediumDisabled && easyDisabled) {
                hardDisabled = false;
                setUnpause();
            }
        });
    ...
    public void handleInput() {
        ...
        if (keyPressed.getOrDefault(KeyCode.SPACE, false) && canShoot) {
            ...
            ProjectLines projectlines = new ProjectLines(root, imageView,
                    ...
                    (int) ship.getCharacter().getTranslateY() + 5, 10, 30);

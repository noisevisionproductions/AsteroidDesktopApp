...
public class SceneManager {
    ...
    public void setShip(ImageView chosenShip) {
        this.ship = new Ship(chosenShip, 50, 50, 500, 501);
    }
    ...
    public void switchToGameState(ActionEvent event) throws IOException {
        GameStateScene gameStateScene = new GameStateScene();
        root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/asteroids/fxml/gamestate.fxml")));
    ...
    public void switchToMainMenu(ActionEvent event) throws IOException {
        root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/asteroids/fxml/mainmenu.fxml")));
        stage = (Stage) (((Node) event.getSource()).getScene().getWindow());
    ...
    public void switchToOptionsMenu(ActionEvent event) throws IOException {
        root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/asteroids/fxml/optionsmenu.fxml")));
        stage = (Stage) (((Node) event.getSource()).getScene().getWindow());
        root.addEventFilter(KeyEvent.KEY_PRESSED, eventt -> {
            if (eventt.getCode() == KeyCode.ESCAPE) {
                try {
